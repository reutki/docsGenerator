    ...
    return (
        ...
        <Document>
            <Page orientation='landscape' size='A4'>
                <title>Implementation Charter – Build data and measurement systems to improve "{name}"</title>
                <View>
                    <Text>Initiative</Text>
                    <Text>Build data and measurement systems using “mechanism 1”, “mechanism 2”, and “mechanism n” mechanisms. </Text>
                </View>
                <View>
